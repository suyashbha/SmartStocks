...
export default function Recommendation() {
  ...
  const handleSearch = async () => {
    ...
    try {
      ...
      const name =
        stockList.find((s) => s.symbol === res.data.symbol)?.name ||
        selectedStock.name;
            ...
            <>
              ...
              <div className="result-grid">
                <div>
                  ...
                  {result.MARKET_CAP_raw ?? <span className="na">N/A</span>}
                </div>
                <div>
                ...
                <div>
                  ...
                  {result.NO_OF_SHARES_raw ?? <span className="na">N/A</span>}
                </div>
                <div>
                  <strong>Face Value:</strong>{" "}
                  {result.FACE_VALUE_raw ?? <span className="na">N/A</span>}
                </div>
                <div>
                  <strong>Cash:</strong>{" "}
                  {result.CASH_raw ?? <span className="na">N/A</span>}
                </div>
                <div>
                  <strong>Debt:</strong>{" "}
                  {result.DEBT_raw ?? <span className="na">N/A</span>}
                </div>
                <div>
                ...
                <div>
                  ...
                  {result["P/E_raw"] ?? <span className="na">N/A</span>}
                </div>
                <div>
                  <strong>PB Ratio:</strong>{" "}
                  {result["P/B_raw"] ?? <span className="na">N/A</span>}
                </div>
                <div>
                  <strong>ROE:</strong>{" "}
                  {result.ROE_raw ?? <span className="na">N/A</span>}
                </div>
                <div>
                  <strong>ROCE:</strong>{" "}
                  {result.ROCE_raw ?? <span className="na">N/A</span>}
                </div>
                <div>
                  <strong>EPS:</strong>{" "}
                  {result.EPS_TTM_raw ?? <span className="na">N/A</span>}
                </div>
                <div>
                  <strong>Dividend Yield:</strong>{" "}
                  {result["DIV._YIELD_raw"] ?? <span className="na">N/A</span>}
                </div>
                <div>
                  <strong>Sales Growth:</strong>{" "}
                  {result.SALES_GROWTH_raw ?? <span className="na">N/A</span>}
                </div>
                <div>
                  <strong>Profit Growth:</strong>{" "}
                  {result.PROFIT_GROWTH_raw ?? <span className="na">N/A</span>}
                </div>
              </div>
            </>
          )}
